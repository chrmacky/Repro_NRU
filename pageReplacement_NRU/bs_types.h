...
typedef struct memoryEventStackEntry_struct
{
	//struct memoryEvent_t *entry;
	unsigned pid; 
	unsigned time;
	action_t *action;
	struct memoryEventStackEntry_struct *next;
} memoryEventStackEntry;
typedef memoryEventStackEntry* memoryEventStack;
#endif  /* __BS_TYPES__ */ 